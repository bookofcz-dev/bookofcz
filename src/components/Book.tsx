              ...
              {showCover ? (
                ...
                >
                  <div className="flex-1 overflow-y-auto pr-2 md:pr-4 custom-scrollbar relative z-10">
                    ...
                    {leftPage < totalPages && (
                      <>
                        <h2 className={`${content[leftPage].title === 'Quote 1' || content[leftPage].title === 'Quote 2' || content[leftPage].title === 'Quote 3' || content[leftPage].title === 'Quote 4' || content[leftPage].title === 'Quote 5' || content[leftPage].title === 'Quote 6' || content[leftPage].title === 'Quote 7' || content[leftPage].title === 'Quote 8' || content[leftPage].title === 'Quote 9' || content[leftPage].title === 'Quote 10' || content[leftPage].title === 'Quote 11' || content[leftPage].title === 'Quote 12' || content[leftPage].title === 'Quote 13' || content[leftPage].title === 'Quote 14' ? 'text-3xl md:text-4xl' : 'text-xl md:text-2xl'} font-bold mb-2 md:mb-4 ${content[leftPage].title === 'Quote 14' ? 'text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]' : content[leftPage]?.backgroundImage ? 'text-yellow-400' : content[leftPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-primary'}`}>
                        ...
                        <div className={`${content[leftPage].title === 'Quote 1' || content[leftPage].title === 'Quote 2' || content[leftPage].title === 'Quote 3' || content[leftPage].title === 'Quote 4' || content[leftPage].title === 'Quote 5' || content[leftPage].title === 'Quote 6' || content[leftPage].title === 'Quote 7' || content[leftPage].title === 'Quote 8' || content[leftPage].title === 'Quote 9' || content[leftPage].title === 'Quote 10' || content[leftPage].title === 'Quote 11' || content[leftPage].title === 'Quote 12' || content[leftPage].title === 'Quote 13' || content[leftPage].title === 'Quote 14' ? 'text-xl md:text-3xl font-semibold tracking-wide' : 'text-base md:text-base'} leading-relaxed whitespace-pre-line ${content[leftPage].title === 'Quote 14' ? 'text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.95)] font-bold' : content[leftPage]?.backgroundImage ? 'text-yellow-100/95' : content[leftPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-foreground'}`}>
                ...
                >
                  <div className="flex-1 overflow-y-auto pr-2 md:pr-4 custom-scrollbar relative z-10">
                    ...
                    {rightPage < totalPages && (
                      <>
                        <h2 className={`${content[rightPage].title === 'Quote 1' || content[rightPage].title === 'Quote 2' || content[rightPage].title === 'Quote 3' || content[rightPage].title === 'Quote 4' || content[rightPage].title === 'Quote 5' || content[rightPage].title === 'Quote 6' || content[rightPage].title === 'Quote 7' || content[rightPage].title === 'Quote 8' || content[rightPage].title === 'Quote 9' || content[rightPage].title === 'Quote 10' || content[rightPage].title === 'Quote 11' || content[rightPage].title === 'Quote 12' || content[rightPage].title === 'Quote 13' || content[rightPage].title === 'Quote 14' ? 'text-3xl md:text-4xl' : 'text-xl md:text-2xl'} font-bold mb-2 md:mb-4 ${content[rightPage].title === 'Quote 14' ? 'text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]' : content[rightPage]?.backgroundImage ? 'text-yellow-400' : content[rightPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-primary'}`}>
                        ...
                        <div className={`${content[rightPage].title === 'Quote 1' || content[rightPage].title === 'Quote 2' || content[rightPage].title === 'Quote 3' || content[rightPage].title === 'Quote 4' || content[rightPage].title === 'Quote 5' || content[rightPage].title === 'Quote 6' || content[rightPage].title === 'Quote 7' || content[rightPage].title === 'Quote 8' || content[rightPage].title === 'Quote 9' || content[rightPage].title === 'Quote 10' || content[rightPage].title === 'Quote 11' || content[rightPage].title === 'Quote 12' || content[rightPage].title === 'Quote 13' || content[rightPage].title === 'Quote 14' ? 'text-xl md:text-3xl font-semibold tracking-wide' : 'text-base md:text-base'} leading-relaxed whitespace-pre-line ${content[rightPage].title === 'Quote 14' ? 'text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.95)] font-bold' : content[rightPage]?.backgroundImage ? 'text-yellow-100/95' : content[rightPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-foreground'}`}>
