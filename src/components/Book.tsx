              ...
              {showCover ? (
                ...
                >
                  <div className="flex-1 overflow-y-auto pr-2 md:pr-4 custom-scrollbar relative z-10">
                    ...
                    {leftPage < totalPages && (
                      <>
                        <h2 className={`${content[leftPage].title === 'Quote 1' || content[leftPage].title === 'Quote 2' || content[leftPage].title === 'Quote 3' || content[leftPage].title === 'Quote 4' || content[leftPage].title === 'Quote 5' || content[leftPage].title === 'Quote 6' || content[leftPage].title === 'Quote 7' ? 'text-2xl md:text-4xl' : 'text-lg md:text-2xl'} font-bold mb-2 md:mb-4 ${content[leftPage]?.backgroundImage ? 'text-yellow-400' : content[leftPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-primary'}`}>
                        ...
                        <div className={`${content[leftPage].title === 'Quote 1' || content[leftPage].title === 'Quote 2' || content[leftPage].title === 'Quote 3' || content[leftPage].title === 'Quote 4' || content[leftPage].title === 'Quote 5' || content[leftPage].title === 'Quote 6' || content[leftPage].title === 'Quote 7' ? 'text-lg md:text-2xl font-semibold tracking-wide' : 'text-sm md:text-base'} leading-relaxed whitespace-pre-line ${content[leftPage]?.backgroundImage ? 'text-yellow-100/95' : content[leftPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-foreground'}`}>
                ...
                >
                  <div className="flex-1 overflow-y-auto pr-2 md:pr-4 custom-scrollbar relative z-10">
                    ...
                    {rightPage < totalPages && (
                      <>
                        <h2 className={`${content[rightPage].title === 'Quote 1' || content[rightPage].title === 'Quote 2' || content[rightPage].title === 'Quote 3' || content[rightPage].title === 'Quote 4' || content[rightPage].title === 'Quote 5' || content[rightPage].title === 'Quote 6' || content[rightPage].title === 'Quote 7' ? 'text-2xl md:text-4xl' : 'text-lg md:text-2xl'} font-bold mb-2 md:mb-4 ${content[rightPage]?.backgroundImage ? 'text-yellow-400' : content[rightPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-primary'}`}>
                        ...
                        <div className={`${content[rightPage].title === 'Quote 1' || content[rightPage].title === 'Quote 2' || content[rightPage].title === 'Quote 3' || content[rightPage].title === 'Quote 4' || content[rightPage].title === 'Quote 5' || content[rightPage].title === 'Quote 6' || content[rightPage].title === 'Quote 7' ? 'text-lg md:text-2xl font-semibold tracking-wide' : 'text-sm md:text-base'} leading-relaxed whitespace-pre-line ${content[rightPage]?.backgroundImage ? 'text-yellow-100/95' : content[rightPage].title.startsWith('Quote') ? 'text-yellow-400' : 'text-foreground'}`}>
